...
export default class Modal extends React.Component {
  ...
  renderTitle() {
    ...
    return (
      <div className={styles.jm_modal_title}>
        {imageSrc ? (
          <label className={styles.jm_modal_image}>
            <Image src={imageSrc} iconLetter={imageSrc} iconSize={size} />
          </label>
        ) : (
          icon && <Icon type={icon} style={{ fontSize: size }} />
        )}
        <div className={styles.jm_modal_text}>
          <div>{title}</div>
  ...
  render() {
    ...
    return (
      <ReactModal
        className={classnames(styles.jm_modal_wrapper, className, {
          [styles['jm_modal_fullscreen']]: fullScreen,
          [styles['jm_modal_rightScreen']]: rightScreen,
        })}
        style={style}
        isOpen={visible}
      ...
      >
        {!hideHeader && (
          <div className={classnames(styles.jm_modal_header, headerClassName)}>
            {this.renderTitle()}
            {showIcon && (
              <div className={styles.jm_modal_iconBg}>
                {imageSrc ? (
            ...
            {closable && (
              <Button
                className={styles.jm_modal_close}
                icon="close"
                iconSize={24}
                type="control"
                onClick={onCancel}
        ...
        <div className={classnames(styles.jm_modal_body, bodyClassName)}>{children}</div>
        {!hideFooter && (
          <div className={classnames(styles.jm_modal_footer, footerClassName)}>
            {onCancel && (
              <Button
